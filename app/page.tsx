    ...
    <div className="bg-[#0a0a0f] text-gray-100 min-h-screen relative">
      ...
      <nav className="animate-fade-in sticky top-0 z-50 bg-[#0a0a0f]/80 backdrop-blur-xl border-b border-white/5">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <span className="text-xl font-display font-extrabold text-white">MailPulse</span>
      ...
      <section className="relative mx-auto max-w-4xl px-6 pt-24 pb-32 text-center">
        ...
        <h1 className="animate-fade-up [animation-delay:150ms] font-display text-5xl font-extrabold tracking-tight text-white sm:text-6xl lg:text-7xl" style={{ lineHeight: "1.08" }}>
          Send Newsletters Your Subscribers Actually Open
        </h1>
        <p className="animate-fade-up [animation-delay:350ms] mt-6 text-lg text-gray-400 sm:text-xl max-w-2xl mx-auto leading-relaxed">
          Build your list, design beautiful emails, and track what works — without the marketing platform bloat.
        </p>
      ...
      <section id="features" className="bg-[#0a0a0f] py-24">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="text-center font-display text-3xl font-bold text-white mb-4">Everything You Need, Nothing You Don't</h2>
          <p className="text-center text-gray-400 mb-16 max-w-xl mx-auto">
            The essential tools to grow your audience and keep them engaged.
          </p>
          ...
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            ...
            <h3 className="text-lg font-semibold text-white">drag-drop-email-editor</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your drag-drop-email-editor with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">subscriber-list-management</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your subscriber-list-management with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">embeddable-signup-forms</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your embeddable-signup-forms with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your campaign-analytics with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">scheduled-sending</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your scheduled-sending with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your email-templates with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">bulk-import-export</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your bulk-import-export with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">tag-segmentation</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your tag-segmentation with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            ...
            <h3 className="text-lg font-semibold text-white">webhook-integrations</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your webhook-integrations with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">unsubscribe-management</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your unsubscribe-management with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">bounce-tracking</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your bounce-tracking with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">click-tracking</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your click-tracking with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">mobile-responsive-emails</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your mobile-responsive-emails with ease using our intuitive interface.</p>
          </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <h2 className="font-display text-3xl font-bold text-white sm:text-4xl">
            Your First Campaign Goes Out in Minutes
          </h2>
          <p className="mt-4 text-lg text-gray-400 max-w-xl mx-auto">
            No credit card, no setup headaches — just import your list and hit send.
          </p>
          <div className="mt-10">
            <Link
              href="/login"
      ...
      <footer className="border-t border-white/5 py-12">
        <div className="mx-auto max-w-6xl px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="text-sm text-gray-500">&copy; {new Date().getFullYear()} MailPulse. All rights reserved.</span>
