...
export default function NewEmailEventPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const { error: insertError } = await supabase.from("email_events").insert(record);
  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mt-2">Add Email Event</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="card space-y-6">
        ...
        <div>
          ...
          <input id="subscriber_id" name="subscriber_id" type="text" className="input" placeholder="Enter subscriber id" />
        </div>
        <div>
        ...
        <div>
          ...
          <input id="sendgrid_message_id" name="sendgrid_message_id" type="text" className="input" placeholder="Enter sendgrid message id" />
        </div>
        <div>
        ...
        <div>
          ...
          <input id="url" name="url" type="url" className="input" placeholder="Enter url" />
        </div>
        <div>
          <label htmlFor="ip" className="label">Ip</label>
          <input id="ip" name="ip" type="text" className="input" placeholder="Enter ip" />
        </div>
        <div>
        ...
        <div>
          ...
          <input id="reason" name="reason" type="text" className="input" placeholder="Enter reason" />
        </div>
        <div>
          <label htmlFor="raw_event" className="label">Raw Event</label>
          <input id="raw_event" name="raw_event" type="text" className="input" placeholder="Enter raw event" />
        </div>

        <div className="flex items-center gap-3 pt-4 border-t">
          <button type="submit" disabled={loading} className="btn-primary">
            {loading ? "Saving..." : "Create Email Event"}
          </button>
